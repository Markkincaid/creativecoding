...
function draw() {
  ...
  image(grass, width - 1000, height - 250, grass.width, grass.height - 250);
  image(pumpkin, width - 925, height - 450, pumpkin.width / 2, pumpkin.height / 2);
  image(ghost, width - 250, ghostY, ghost.width / 2, ghost.height / 2);
